...
public class VerificandoSenhas {
	...
	public static String verificarForcaSenha(String senha) {
		...
		if(senha.length() < comprimentoMinimo) {
			...
			return "Sua senha nao atende aos requisitos minímos de segurança";
		} else if (temSequenciaComum || temPalavraComum) {
			return "Sua senha não atende aos requisitos minímos de segurança. Evite sequencias ou palavras comuns";
		} else {
			return "Sua senha atende aos requisitos de segurança. Parabens!";
		}
